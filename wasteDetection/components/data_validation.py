...
class DataValidation:
    ...
    def validate_all_files_exist(self)-> bool:
        try:
            ...
            all_files = os.listdir(self.data_ingestion_artifact.data_file_path)
...
if __name__ == "__main__":
    try:
        ...
        artifact = DataIngestionArtifact(data_file_path='artifacts/data_ingestion/waste-detection-1')
        validation = DataValidation(data_ingestion_artifact=artifact,
                                   data_validation_config=config)
        validation_artifact = validation.validate_all_files_exist()
